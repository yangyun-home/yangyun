		    ...
		    <form class="layui-form" id="fromChangeArea" action="">
		        ...
		        <div class="layui-form-item">
		            ...
		            <span class="layui-badge layui-bg-orange"></span>
		             ...
		             <!--  <textarea rows="10" cols="30" id="imgIdentResultLocation" ></textarea> -->
		              <!-- <img width="300px" height="300px" src="" id="imgIdentResultLocation"> -->
		        </div>
...
<script language="javascript">
    ...
    var tableObj = table.render({
                elem: '#demo'
                ,id:'pictureTableDatas'
                , height: 750
                , url: '${APP_PATH}/up_files/getImageDataPage' //数据接口
                , method: 'GET'
                , title: '用户表'
                , page:true//开启分页
			 ...
			 // 执行搜索，表格重载
			    $('#searchBtn').on('click', function () {
			    	...
			    	if(send_Name == null || send_Name == ""){
			    		layer.msg('搜索内容不能为空',{time:2000,icon:2,shade:0.3});
			    	}else{
			    		table.reload('pictureTableDatas', {
				            method: 'GET'
				            , where: {
				                'send_name': send_Name,
				            }
